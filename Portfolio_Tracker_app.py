...
def check_dependencies():
    ...
    try:
        ...
        st.sidebar.warning("Prophet not installed - forecasting features limited")
        
    try:
        from statsmodels.tsa.arima.model import ARIMA
        dependencies['statsmodels'] = True
    except ImportError:
        st.sidebar.warning("statsmodels not installed - forecasting features limited")
...
def load_ticker_list():
    ...
    try:
        ...
        return [
            ...
            "V", "PG", "MA", "HD", "DIS", "ADBE", "PYPL", "NFLX", "CRM", "PEP",
            # Top ETFs
            ...
            "BABA", "TSM", "ASML", "NVO", "SAP", "UL", "NSRGY", "TM", "SONY", "TCEHY",
            # Biotech and Pharma
...
def main():
    ...
    # Metrics Calculation
    metrics = calculate_metrics(portfolio_value.to_frame(), bench_data, risk_free)
